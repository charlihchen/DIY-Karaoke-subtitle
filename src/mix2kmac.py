...
class FFmpegMixerApp:  
    def __init__(self, root):  
        self.root = root  
        self.root.title("Load Video and Audio to mix into Karaoke Song by FFmpeg")  
...
if __name__ == "__main__":  
    ...
    root.mainloop()  
# Note:  
# Ensure you have ffmpeg installed on your macOS M1 (e.g., via Homebrew: `brew install ffmpeg`)  
# The Video file and audio file must be accessible in the specified paths.  
