...
class FFmpegMixerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("FFmpeg Video and Audio Mixer for Karaoke Song")
    ...
    def mix_media(self):
        ...
        # Use 'ffmpeg' command directly as it should be in PATH on macOS
        command = [
            'ffmpeg',
            '-i', video_file,
            '-i', audio_file,
        ...
        try:
            ...
            messagebox.showerror("Error", "FFmpeg not found. Please ensure FFmpeg is installed and available in your system PATH.")
